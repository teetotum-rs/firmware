...
pub const LINKS: [Link; 12] = [
    ...
    Link {
        slot: 11,
        name: "Web installer",
        caption: "flash from a browser",
        host: "teetotum-rs.github.io",
        url: "https://teetotum-rs.github.io/firmware/",
    },
    Link {
        slot: 7,
        name: "App",
        caption: "the Android app",
        host: "github.com",
        url: "https://github.com/teetotum-rs/app/releases/latest",
    },
];
